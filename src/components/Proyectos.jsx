      ...
      <div id="proyectos" className="container mx-auto py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-white rounded-lg shadow-md p-6">
            <img src={"/images/" + proyecto.id + ".png"} alt="Proyecto 1" className="w-full mb-4 rounded-lg"></img>
        ...
        <div className="container mx-auto text-center">
          <Link to="/inicio" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Volver Atrás</Link>
        </div>
      </div>
