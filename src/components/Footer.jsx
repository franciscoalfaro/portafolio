  ...
  <footer id="descarga-cv" className="bg-gray-800 text-white py-8 px-4">
    <div className="container mx-auto flex justify-center items-center">
      ...
      <div className="flex items-center">
        <span className="mr-4 text-muted text-sm">
          <a href="https://github.com/franciscoalfaro/" target="_blank">
        ...
        <span className="text-muted text-sm">
          <a href="https://www.linkedin.com/in/francisco-alfaro-ba8143183/" target="_blank">
